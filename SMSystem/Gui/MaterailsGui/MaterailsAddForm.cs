...
namespace SMSystem.Gui.MaterailsGui
{
    public partial class MaterailsAddForm : Form
    {
        ...
        private Data.EF.IDataHelper<Materails> _dataHelper;
        private Data.EF.IDataHelper<Store> _dataHelperforStore;
        ...
        public MaterailsAddForm(int Id, MaterailsUserControl storeUserControl)
        {
           ...
           _dataHelperforStore = (Data.EF.IDataHelper<Store>)ContainerConfig.ObjectType("Stores");
