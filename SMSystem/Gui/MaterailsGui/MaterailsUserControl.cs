...
namespace SMSystem.Gui.MaterailsGui
{
    ...
    {
        // Fields
        private readonly Data.EF.IDataHelper<Materails> _dataHelper;
        private readonly Data.EF.IDataHelper<Income> _dataHelperForIcome;
        ...
        public MaterailsUserControl()
        {
            ...
            _dataHelper = (Data.EF.IDataHelper<Materails>)ContainerConfig.ObjectType("Materails");
            _dataHelperForIcome = (Data.EF.IDataHelper<Income>)ContainerConfig.ObjectType("Income");
