...
namespace SMSystem.Gui.CustomersGui
{
    public partial class AddCustomerConscienceCard : Form
    {
        ...
        private Data.EF.IDataHelper<ConscienceCard> _dataHelper;
        private Data.EF.IDataHelper<Materails> _dataHelperForMaterials;
        private Data.EF.IDataHelper<Customer> _dataHelperForSuppliers;
        ...
        public AddCustomerConscienceCard(int Id, CustomerConscienceCardUserForm MaterialUserControl,int CustomerId, string DepName)
        {
            ...
            _dataHelper = (Data.EF.IDataHelper<ConscienceCard>)ContainerConfig.ObjectType("ConscienceCard");
            _dataHelperForMaterials = (Data.EF.IDataHelper<Materails>)ContainerConfig.ObjectType("Materails");
            _dataHelperForSuppliers = (Data.EF.IDataHelper<Customer>)ContainerConfig.ObjectType("Customers");
