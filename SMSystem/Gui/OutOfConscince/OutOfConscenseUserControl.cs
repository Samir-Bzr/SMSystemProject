...
{
    public partial class OutOfConscenseUserControl : UserControl
    {
        // Fields
        private readonly Data.EF.IDataHelper<OutOfConscinesMaterials> _dataHelper;
        private readonly LoadingUser loading;
        private int MaterialId;
        private static OutOfConscenseUserControl _OutOfConscinesMaterialsUser;
        ...
        // Constructores
        public OutOfConscenseUserControl()
        {
            InitializeComponent();
            labelEmptyData = ComponentsObject.Instance().LabelEmptyData();
            _dataHelper = (Data.EF.IDataHelper<OutOfConscinesMaterials>)ContainerConfig.ObjectType("OutOfConscinesMaterials");
        ...
        {
            return _OutOfConscinesMaterialsUser ?? (new OutOfConscenseUserControl());
        }
        ...
        {
            OutOfConscenseAddForm IncomeAdd = new OutOfConscenseAddForm(0, this, new MaterailsGui.MaterailsUserControl());
            IncomeAdd.Show();
        }
        ...
        private void buttonEdit_Click(object sender, EventArgs e)
        {
            ...
            if (dataGridView.RowCount > 0)
            {
                ...
                OutOfConscenseAddForm IncomeAdd = new OutOfConscenseAddForm(RowId, this, new MaterailsGui.MaterailsUserControl());
