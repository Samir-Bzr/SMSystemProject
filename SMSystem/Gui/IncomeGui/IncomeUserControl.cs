...
namespace SMSystem.Gui.IncomeGui
{
    ...
    {
        // Fields
        private readonly Data.EF.IDataHelper<Income> _dataHelper;
        private readonly Data.EF.IDataHelper<Materails> _dataHelperForMaterial;
        private readonly Data.EF.IDataHelper<Damage> _dataHelperForDamag;
        private readonly Data.EF.IDataHelper<OutOfConscinesMaterials> _dataHelperForOutOfConscince;
        ...
        public IncomeUserControl()
        {
            ...
            _dataHelper = (Data.EF.IDataHelper<Income>)ContainerConfig.ObjectType("Income");
            _dataHelperForMaterial = (Data.EF.IDataHelper<Materails>)ContainerConfig.ObjectType("Materails");
            _dataHelperForDamag = (Data.EF.IDataHelper<Damage>)ContainerConfig.ObjectType("Damage");
            _dataHelperForOutOfConscince = (Data.EF.IDataHelper<OutOfConscinesMaterials>)ContainerConfig.ObjectType("OutOfConscinesMaterials");
