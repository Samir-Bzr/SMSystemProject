...
{
    public partial class DamageAddForm : Form
    {
        // Fileds
        #region Fileds
        private readonly int id;
        private readonly DamageUserControl DamageUserControl;
        ...
        private Data.EF.IDataHelper<Damage> _dataHelper;
        private Data.EF.IDataHelper<Materails> _dataHelperforMaterail;
        private Data.EF.IDataHelper<Supplier> _dataHelperforSupplier;
        ...
        // Constructores
        public DamageAddForm(int Id, DamageUserControl MaterialUserControl, MaterailsUserControl materailsUserControl)
        {
            InitializeComponent();
            // Set Property Instance
            id = Id;
            this.DamageUserControl = MaterialUserControl;
            ...
            _dataHelper = (Data.EF.IDataHelper<Damage>)ContainerConfig.ObjectType("Damage");
            _dataHelperforMaterail = (Data.EF.IDataHelper<Materails>)ContainerConfig.ObjectType("Materails");
            _dataHelperforSupplier = (Data.EF.IDataHelper<Supplier>)ContainerConfig.ObjectType("Suppliers");
        ...
        private void DamageAddForm_Load(object sender, EventArgs e)
        {
            LoadMaterailsName();
            LoadSupplierName();
            LoadMaterailsCode();
